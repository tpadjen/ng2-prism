...
System.registerDynamic("src/src.service", ["angular2/core", "angular2/http", "rxjs/Observable", "rxjs/add/observable/empty", "rxjs/add/operator/map", "rxjs/add/operator/filter", "rxjs/add/operator/distinctUntilChanged", "rxjs/add/operator/debounceTime", "rxjs/add/operator/do", "rxjs/add/operator/retry", "rxjs/add/operator/catch", "rxjs/add/operator/switchMap", "./codeblock.component"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  ...
  var codeblock_component_1 = $__require('./codeblock.component');
