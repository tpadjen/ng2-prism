...
describe('element', function() {
  ...
  it('should have no effect while calling addEventListener without listener', function() {
    var eventListenerZone = global.zone.fork({addEventListener: jasmine.createSpy('addEventListener')});
    expect(function() {
  ...
  it('should have no effect while calling removeEventListener without listener', function() {
    var eventListenerZone = global.zone.fork({removeEventListener: jasmine.createSpy('removeEventListener')});
    expect(function() {
      eventListenerZone.run(function() {
  ...
  describe('onclick', function() {
    function supportsOnClick() {
      ...
      return !(EventTarget && div instanceof EventTarget && clickPropDesc && clickPropDesc.value === null);
    }
