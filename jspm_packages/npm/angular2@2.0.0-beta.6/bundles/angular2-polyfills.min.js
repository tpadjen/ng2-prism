...
(function(process) {
  !function(t) {
    ...
    (function(t) {
      ...
      var i,
          a = "undefined" != typeof Promise && -1 !== Promise.toString().indexOf("[native code]"),
    ...
    (function(t, o) {
      (function() {
        ...
        function h() {
          ...
          return t.port1.onmessage = y, function() {
        ...
        function F(t, e, n, r) {
          var o,
              ...
              s = a(n);
          if (s) {
            if (o = x(n, r), o === ut ? (c = !0, i = o.error, o = null) : u = !0, e === o)
              return void M(e, b());
          } else
            o = r, u = !0;
        ...
        function C(t, e) {
          var n = this;
          n._instanceConstructor = t, n.promise = new t(m), n._validateInput(e) ? (n._input = e, n.length = e.length, n._remaining = e.length, n._init(), 0 === n.length ? j(n.promise, n._result) : (n.length = n.length || 0, n._enumerate(), 0 === n._remaining && j(n.promise, n._result))) : M(n.promise, n._validationError());
        }
        function R(t) {
        ...
        function q(t) {
          ...
          var r = this,
              o = new r(m);
          if (!G(t))
            return M(o, new TypeError("You must pass an array to race.")), o;
          for (var i = t.length,
        ...
        function $(t) {
          this._id = ht++, this._state = void 0, this._result = void 0, this._subscribers = [], m !== t && (a(t) || I(), this instanceof $ || D(), L(this, t));
        }
        function H() {
          var e;
        ...
        var U,
            ...
            V = ({}.toString, function(t, e) {
              nt[B] = t, nt[B + 1] = e, B += 2, 2 === B && (K ? K(y) : X());
            }),
        ...
        var st = R,
            ...
            ht = 0,
            dt = $;
        $.all = st, $.race = ft, $.resolve = pt, $.reject = lt, $._setScheduler = c, $._setAsap = s, $._asap = V, $.prototype = {
          constructor: $,
          then: function(t, e) {
            var n = this,
                r = n._state;
    ...
    (function(r) {
      ...
      var u = n(9);
      r.Promise ? e.bindPromiseFn = function(t) {
        return function() {
    ...
    (function(t) {
      ...
      function c(e) {
        e[f.common.addEventListener] = e.addEventListener, e.addEventListener = function(e, n, r) {
          if (n && "[object FunctionWrapper]" !== n.toString()) {
            ...
            }(n) : n, n[p] = o, n[l] = n[l] || {}, n[l][i] = n[l][i] || t.zone.bind(o), arguments[1] = n[l][i];
          }
          var a = this || t;
          return t.zone.addEventListener.apply(a, arguments);
        }, e[f.common.removeEventListener] = e.removeEventListener, e.removeEventListener = function(e, n, r) {
      ...
      function s(e) {
        ...
        if (n) {
          t[e] = function() {
            ...
            switch (t.length) {
              ...
              case 1:
                ...
                break;
              case 2:
                this[h] = new n(t[0], t[1]);
                break;
              case 3:
                this[h] = new n(t[0], t[1], t[2]);
                break;
              case 4:
                this[h] = new n(t[0], t[1], t[2], t[3]);
                break;
              default:
          ...
          for (o in i)
            !function(n) {
              "function" == typeof i[n] ? t[e].prototype[n] = function() {
                return this[h][n].apply(this[h], arguments);
              } : Object.defineProperty(t[e].prototype, n, {
                set: function(e) {
                  "function" == typeof e ? this[h][n] = t.zone.bind(e) : this[h][n] = e;
                },
                get: function() {
                  return this[h][n];
                }
          ...
          for (o in n)
            "prototype" !== o && n.hasOwnProperty(o) && (t[e][o] = n[o]);
        }
      }
      var f = n(7);
      e.bindArguments = r, e.patchPrototype = o, e.isWebWorker = i, e.patchProperty = a, e.patchProperties = u;
      var p = f.create("originalFn"),
          l = f.create("boundFns");
      e.patchEventTargetMethods = c;
      var h = f.create("originalInstance");
      e.patchClass = s;
    }).call(e, function() {
      return this;
    }());
    ...
    (function(t) {
      function r() {
        o.patchSetClearFunction(t, t.Zone, [["setTimeout", "clearTimeout", !1, !1], ["setInterval", "clearInterval", !0, !1], ["setImmediate", "clearImmediate", !1, !1], ["requestAnimationFrame", "cancelAnimationFrame", !1, !0], ["mozRequestAnimationFrame", "mozCancelAnimationFrame", !1, !0], ["webkitRequestAnimationFrame", "webkitCancelAnimationFrame", !1, !0]]), o.patchFunction(t, ["alert", "prompt"]), s.apply(), f.apply(), i.apply(), a.patchClass("MutationObserver"), a.patchClass("WebKitMutationObserver"), u.apply(), c.apply(), p.apply(), l.apply();
      }
      var o = n(11),
          i = n(8),
          a = n(13),
          ...
          for (o in r)
            !function(n) {
              "undefined" == typeof t[e].prototype && ("function" == typeof r[n] ? t[e].prototype[n] = function() {
                ...
                set: function(e) {
                  "function" == typeof e ? this[i][n] = t.zone.bind(e) : this[i][n] = e;
                },
                get: function() {
                  return this[i][n];
                }
    ...
    (function(t) {
      function r() {
        if (!i.isWebWorker() && "registerElement" in t.document) {
    ...
    (function(t) {
      ...
      function r() {
        if (t.EventTarget)
          o.patchEventTargetMethods(t.EventTarget.prototype);
        else {
      ...
      function r() {
        if (!u.isWebWorker()) {
          ...
          if (o()) {
            ...
            u.patchProperties(HTMLElement.prototype, e), u.patchProperties(XMLHttpRequest.prototype), t && u.patchProperties(WebSocket.prototype);
          } else
            i(), u.patchClass("XMLHttpRequest"), t && a.apply();
        }
      }
      function o() {
      ...
      function i() {
        s.forEach(function(e) {
          ...
          document.addEventListener(e, function(e) {
            for (var r,
                o = e.target; o; )
              o[n] && !o[n][f] && (r = t.zone.bind(o[n]), r[f] = o[n], o[n] = r), o = o.parentElement;
          }, !0);
        });
      }
      var a = n(18),
      ...
      e.longStackTraceZone = {
        getLongStacktrace: function(t) {
          ...
          for (var r = Date.now(); n && n.constructedAtException; )
            e.push("--- " + new Date(n.constructedAtTime).toString() + " - " + (r - n.constructedAtTime) + "ms ago", n.constructedAtException.get()), n = n.parent;
          return e.join("\n");
        },
  ...
  !function(t) {
    ...
    function f(t, e, n) {
      ...
      if (r.size > 0)
        return !0;
      var o = R.get(e);
      return o["delete"](n), o.size > 0 ? !0 : (R["delete"](e), !0);
    }
    function p(t, e) {
 ...
 while (s.call(f, t));
    ...
    var x = Object.getPrototypeOf(Function),
        F = "function" == typeof Map ? Map : S(),
        L = "function" == typeof Set ? Set : A(),
        C = "function" == typeof WeakMap ? WeakMap : z(),
        R = new C;
    t.decorate = e, t.metadata = n, t.defineMetadata = r, t.hasMetadata = o, t.hasOwnMetadata = i, t.getMetadata = a, t.getOwnMetadata = u, t.getMetadataKeys = c, t.getOwnMetadataKeys = s, t.deleteMetadata = f, function(e) {
