    ...
    return function a(b, f, h) {
      ...
      2: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          e.prototype._subscribe = function(c) {
            var d = a.prototype._subscribe.call(this, c);
            d && !d.isUnsubscribed && c.next(this._value);
            return d;
          };
          e.prototype._next = function(c) {
            a.prototype._next.call(this, this._value = c);
          };
          e.prototype._error = function(c) {
            this.hasErrored = !0;
            a.prototype._error.call(this, this.errorValue = c);
          };
          return e;
        }(b.Subject);
        f.BehaviorSubject = a;
      ...
      9: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          c.prototype._next = function(d) {
            var c = this._getNow();
            this.events.push(new g(c, d));
            this._trimBufferThenGetEvents(c);
            a.prototype._next.call(this, d);
          };
          c.prototype._subscribe = function(d) {
            var c = this._trimBufferThenGetEvents(this._getNow()),
                n = this.scheduler;
            n && d.add(d = new l.ObserveOnSubscriber(d, n));
            for (var n = -1,
                b = c.length; ++n < b && !d.isUnsubscribed; )
              d.next(c[n].value);
          ...
          c.prototype._trimBufferThenGetEvents = function(a) {
            for (var c = this.bufferSize,
                e = this._windowTime,
                b = this.events,
                g = b.length,
                f = 0; f < g && !(a - b[f].time < e); )
              f += 1;
      ...
      11: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype.lift = function(a) {
            var d = new b(this.destination || this, this);
            d.operator = a;
            return d;
          };
          ...
          b.prototype._subscribe = function(a) {
            ...
            if (!a.isUnsubscribed) {
              ...
              var d = new g.SubjectSubscription(this, a);
          ...
          b.prototype._finalComplete = function() {
            ...
            this.isUnsubscribed = !0;
            if (d)
              for (var c = d.length; ++a < c; )
                d[a].complete();
            this.isUnsubscribed = !1;
            this.unsubscribe();
          };
          b.prototype.throwIfUnsubscribed = function() {
            this.isUnsubscribed && c.throwError(new d.ObjectUnsubscribedError);
          };
      ...
      13: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          d.prototype[l.$$rxSubscriber] = function() {
            return this;
          };
          return d;
        }(b.Subscription);
        ...
        var e = function(a) {
          function d(d, e, b, g) {
            ...
            var f;
            d = this;
            k.isFunction(e) ? f = e : e && (d = e, f = e.next, b = e.error, g = e.complete, k.isFunction(d.unsubscribe) && this.add(d.unsubscribe.bind(d)), d.unsubscribe = this.unsubscribe.bind(this));
            this._context = d;
            this._next = f;
            this._error = b;
            this._complete = g;
          ...
          a.prototype.unsubscribe = function() {
            ...
            if (!this.isUnsubscribed) {
              ...
              if (h.isArray(f))
                for (var b = -1,
                    t = f.length; ++b < t; )
                  p = f[b], k.isObject(p) && (p = g.tryCatch(p.unsubscribe).call(p), p === e.errorObject && (a = !0, d = d || [], p = e.errorObject.e, p instanceof c.UnsubscriptionError ? d = d.concat(p.errors) : d.push(p)));
              if (a)
      ...
      119: [function(a, b, f) {
        ...
        a = function(a) {
          function e(c, d, e, n) {
            ...
            this.arrayLike = c;
            this.scheduler = n;
            d || n || 1 !== c.length || (this._isScalar = !0, this.value = c[0]);
            d && (this.mapFn = d.bind(e));
          }
          h(e, a);
          e.create = function(a, d, m, n) {
            var b = a.length;
            return 0 === b ? new l.EmptyObservable : 1 !== b || d ? new e(a, d, m, n) : new k.ScalarObservable(a[0], n);
          };
          e.dispatch = function(a) {
            var d = a.arrayLike,
                ...
                b = a.mapFn,
                g = a.subscriber;
            g.isUnsubscribed || (e >= n ? g.complete() : (d = b ? b(d[e], e) : d[e], g.next(d), a.index = e + 1, this.schedule(a)));
          };
      ...
      120: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          c.of = function() {
            ...
            var b = a.length;
            return 1 < b ? new c(a, e) : 1 === b ? new k.ScalarObservable(a[0], e) : new l.EmptyObservable(e);
          };
          c.dispatch = function(a) {
            var c = a.array,
                e = a.index,
                b = a.subscriber;
            e >= a.count ? b.complete() : (b.next(c[e]), b.isUnsubscribed || (a.index = e + 1, this.schedule(a)));
          };
      ...
      121: [function(a, b, f) {
        function h(a) {
          ...
          var f = g.callbackFunc,
              ...
              q = g.subject;
          if (!q) {
            var q = g.subject = new d.AsyncSubject,
                v = function x() {
                  for (var a = [],
                  ...
                  var m = x.source,
                      d = m.selector,
                      m = m.subject;
                  d ? (a = e.tryCatch(d).apply(this, a), a === c.errorObject ? b.add(t.schedule(l, 0, {
                    err: c.errorObject.e,
                    subject: m
            ...
            v.source = g;
            e.tryCatch(f).apply(this, h.concat(v)) === c.errorObject && q.error(c.errorObject.e);
          }
          b.add(q.subscribe(a));
        }
        function k(a) {
        ...
        a = function(a) {
          ...
          b.prototype._subscribe = function(a) {
            ...
            g || (g = this.subject = new d.AsyncSubject, n = function y() {
              for (var a = [],
                  d = 0; d < arguments.length; d++)
                a[d - 0] = arguments[d];
              var m = y.source,
                  d = m.selector,
                  m = m.subject;
              d ? (a = e.tryCatch(d).apply(this, a), a === c.errorObject ? m.error(c.errorObject.e) : (m.next(a), m.complete())) : (m.next(1 === a.length ? a[0] : a), m.complete());
            }, n.source = this, e.tryCatch(m).apply(this, b.concat(n)) === c.errorObject && g.error(c.errorObject.e));
            ...
            var q = g.subject = new d.AsyncSubject,
                v = function x() {
                  ...
                  var m = x.source,
                      ...
                      m = m.subject,
                      g = a.shift();
                  g ? m.error(g) : d ? (a = e.tryCatch(d).apply(this, a), a === c.errorObject ? b.add(t.schedule(l, 0, {
                    err: c.errorObject.e,
                    subject: m
                  })) : b.add(t.schedule(k, 0, {
                    value: a,
      ...
      123: [function(a, b, f) {
        ...
        var l = function(a) {
          ...
          c.prototype._closeSubscription = function() {
          ...
          return c;
            ...
            e = function(a) {
              ...
              e.prototype._subscribe = function(a) {
                ...
                a = new c(a, this);
                var e = d.subscribe(a);
                e.isUnsubscribed || 1 !== ++this.refCount || (a.connection = this.connection = d.connect());
                return e;
              };
              return e;
            }(b.Observable),
            c = function(a) {
              ...
              c.prototype._resetConnectable = function() {
                var a = this.refCountObservable,
                    d = a.connection,
                    c = this.connection;
                c && c === d && (a.refCount = 0, d.unsubscribe(), a.connection = null, this.unsubscribe());
              };
              c.prototype._unsubscribe = function() {
                var a = this.refCountObservable;
                if (0 !== a.refCount && 0 === --a.refCount) {
                  var d = a.connection,
                      c = this.connection;
                  c && c === d && (d.unsubscribe(), a.connection = null);
                }
              };
              return c;
            }(k.Subscriber);
      ...
      127: [function(a, b, f) {
        ...
        b = function(a) {
          ...
          d.create = function() {
            ...
            return 0 === a.length ? new k.EmptyObservable : new d(a, c);
          };
      ...
      128: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          h(c, a);
          c.create = function(a, e, b) {
            return new c(a, e, b);
          };
          c.setupSubscription = function(a, e, b, f) {
            var l;
            if (a && "[object NodeList]" === a.toString() || a && "[object HTMLCollection]" === a.toString())
              for (var k = 0,
                  h = a.length; k < h; k++)
                c.setupSubscription(a[k], e, b, f);
            else
          ...
          c.prototype._subscribe = function(a) {
            var e = this.selector;
            c.setupSubscription(this.sourceObj, this.eventName, e ? function() {
              for (var c = [],
                  b = 0; b < arguments.length; b++)
                c[b - 0] = arguments[b];
              c = k.tryCatch(e).apply(void 0, c);
      ...
      130: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.create = function(a, f, h, t) {
            ...
            if (null != a) {
              ...
              if ("function" === typeof a[u.$$iterator] || "string" === typeof a)
                return new d.IteratorObservable(a, null, null, q);
          ...
          b.prototype._subscribe = function(a) {
            var d = this.ish,
                c = this.scheduler;
            return null == c ? d[r.$$observable]().subscribe(a) : d[r.$$observable]().subscribe(new t.ObserveOnSubscriber(a, c, 0));
          };
          return b;
        }(p.Observable);
        f.FromObservable = a;
        ...
        a = function(a) {
          function e(c, d) {
            ...
            if (!k.isNumeric(c) || 0 > c)
              this.period = 0;
            d && "function" === typeof d.schedule || (this.scheduler = l.async);
          }
          h(e, a);
          ...
          e.dispatch = function(a) {
            var d = a.subscriber,
                e = a.period;
            d.next(a.index);
            d.isUnsubscribed || (a.index += 1, this.schedule(a, e));
          };
          e.prototype._subscribe = function(a) {
            var d = this.period;
        ...
        a = function(a) {
          ...
          b.dispatch = function(a) {
            var c = a.index,
                ...
                b = a.iterator,
                n = a.subscriber;
            a.hasError ? n.error(a.error) : (b = b.next(), b.done ? n.complete() : (m ? (b = g.tryCatch(m).call(e, b.value, c), b === d.errorObject ? (a.error = d.errorObject.e, a.hasError = !0) : (n.next(b), a.index = c + 1)) : (n.next(b.value), a.index = c + 1), n.isUnsubscribed || this.schedule(a)));
          };
          b.prototype._subscribe = function(a) {
            var c = 0,
                e = this.iterator,
        ...
        a = function(a) {
          ...
          b.dispatch = function(a) {
            var e = a.start,
                c = a.index,
                d = a.subscriber;
            c >= a.count ? d.complete() : (d.next(e), d.isUnsubscribed || (a.index = c + 1, a.start = e + 1, this.schedule(a)));
          };
          b.prototype._subscribe = function(a) {
            var e = 0,
                c = this.start,
      ...
      136: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.dispatch = function(a) {
            var e = a.value,
                c = a.subscriber;
            a.done ? c.complete() : (c.next(e), c.isUnsubscribed || (a.done = !0, this.schedule(a)));
          };
          b.prototype._subscribe = function(a) {
            var e = this.value,
                c = this.scheduler;
      ...
      158: [function(a, b, f) {
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new e(a, this.delay, this.scheduler));
          };
          return a;
        }(),
            e = function(a) {
              ...
              d.prototype._next = function(a) {
                this.value = a;
                this.hasValue = !0;
                this.throttled || this.add(this.throttled = this.scheduler.schedule(h, this.delay, this));
              };
      ...
      161: [function(a, b, f) {
        ...
        f.bufferTime = function(a, d, b) {
          void 0 === d && (d = null);
          void 0 === b && (b = e.async);
          return this.lift(new c(a, d, b));
        };
        var c = function() {
          function a(c, d, e) {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new d(a, this.bufferTimeSpan, this.bufferCreationInterval, this.scheduler));
          };
          return a;
        }(),
            d = function(a) {
              function c(d, e, b, g) {
                ...
                if (null !== b && 0 <= b) {
                  ...
                  this.add(g.schedule(l, e, {
                    subscriber: this,
                    buffer: d
                  }));
                  this.add(g.schedule(k, b, n));
                } else
                  this.add(g.schedule(h, e, {
                    subscriber: this,
                    buffer: d,
                    bufferTimeSpan: e
                  }));
      ...
      167: [function(a, b, f) {
        ...
        f.combineLatestStatic = function() {
          for (var a = [],
            ...
            a[d - 0] = arguments[d];
          var e = d = null;
          g.isScheduler(a[a.length - 1]) && (e = a.pop());
          "function" === typeof a[a.length - 1] && (d = a.pop());
          1 === a.length && l.isArray(a[0]) && (a = a[0]);
          return (new k.ArrayObservable(a, e)).lift(new c(d));
        };
        var c = function() {
          function a(c) {
            this.project = c;
        ...
        var g = function() {
          ...
          return a;
            ...
            e = function(a) {
              ...
              h(d, a);
              d.prototype.compare = function(a, c) {
                return a === c;
              };
              d.prototype._next = function(a) {
                var c = a;
          ...
          c.prototype._next = function(a) {
            ...
            if (d.isUnsubscribed)
              ...
              if (this.active < this.concurrent) {
                ...
                b === l.errorObject ? d.error(l.errorObject.e) : this.scheduler ? this.add(this.scheduler.schedule(c.dispatch, 0, {
                  subscriber: this,
                  result: b,
                  value: a,
                  index: e
      ...
      184: [function(a, b, f) {
        ...
        var l = function() {
          function a(c) {
            this.finallySelector = c;
          }
          a.prototype.call = function(a, d) {
            return d._subscribe(new g(a, this.finallySelector));
          };
          return a;
        }(),
            g = function(a) {
      ...
      185: [function(a, b, f) {
        ...
        f.first = function(a, c, d) {
          return this.lift(new l(a, c, d, this));
        };
        var l = function() {
          function a(c, d, e, b) {
            this.predicate = c;
          ...
          return a;
            ...
            m = function(a) {
              ...
              d.prototype._group = function(a, d) {
                ...
                var m = b.get(d);
                m || (b.set(d, m = new g.Subject), b = new r(d, m, this), this.durationSelector && this._selectDuration(d, m), this.destination.next(b));
                this.elementSelector ? this._selectElement(a, m) : this.tryGroupNext(a, m);
              };
              d.prototype._selectElement = function(a, c) {
                var d;
                try {
              ...
              d.prototype._selectDuration = function(a, c) {
                var d;
                try {
              ...
              d.prototype.tryGroupNext = function(a, c) {
      ...
      193: [function(a, b, f) {
        function h() {
          ...
          return 1 === a.length ? a[0] : (new k.ArrayObservable(a, d)).lift(new l.MergeAllOperator(c));
        }
          ...
          c.prototype._next = function(a) {
            if (this.active < this.concurrent) {
              var c = this.resultSelector,
                  ...
                  f = this.destination;
              this.active++;
              this._innerSub(e, f, c, a, b);
            } else
              this.buffer.push(a);
          };
          c.prototype._innerSub = function(a, c, b, e, f) {
      ...
      206: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new l(a, this.project, this.seed));
          };
          return a;
        }();
        f.ReduceOperator = k;
          ...
          return a;
            ...
            l = function(a) {
              ...
              b.prototype._tryNext = function(a) {
                var d;
                try {
                  d = this.accumulator(this.seed, a);
                } catch (b) {
                  this.destination.error(b);
                }
                this.seed = d;
            ...
            l = function(a) {
              ...
              b.prototype._next = function(a) {
                var b = this.destination,
                    e;
                try {
                  e = this.predicate(a, this.index++);
                } catch (f) {
                  b.error(f);
                  return;
                }
                this.nextOrComplete(a, e);
              };
              b.prototype.nextOrComplete = function(a, b) {
                var e = this.destination;
                b ? e.next(a) : e.complete();
              };
              return b;
            }(a.Subscriber);
      }, {"../Subscriber": 13}],
      ...
      229: [function(a, b, f) {
        ...
        f.timeout = function(a, b, e) {
          ...
          return this.lift(new g(a, f, b, e));
        };
        var g = function() {
          function a(c, b, e, f) {
            this.waitFor = c;
      ...
      233: [function(a, b, f) {
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new e(a, this.windowBoundaries));
          };
          return a;
        }(),
            e = function(a) {
            ...
            m = function(a) {
              ...
              b.prototype.notifyNext = function(a, b, d, f, h) {
                if (a === this.openings) {
                  ...
                  f.isUnsubscribed ? this.closeWindow(this.contexts.length - 1) : (f.context = d, b.add(f));
                  this.destination.next(a);
                } else
          ...
          return a;
            ...
            d = function(a) {
              ...
              c.prototype.openWindow = function(a) {
                ...
                this.destination.next(a);
                var c = l.tryCatch(this.closingSelector)();
                c === g.errorObject ? (a = g.errorObject.e, this.destination.error(a), this.window.error(a)) : (this.add(this.closingNotification = e.subscribeToResult(this, c)), this.add(a));
              };
              return c;
            }(b.OuterSubscriber);
      }, {
        ...
        var n = function(a) {
          ...
          c.prototype._next = function(a) {
            var c = this.iterators,
                b = this.index++;
            g.isArray(a) ? c.push(new u(a)) : "function" === typeof a[d.$$iterator] ? c.push(new r(a[d.$$iterator]())) : c.push(new p(this.destination, this, a, b));
          };
          c.prototype._complete = function() {
      ...
      241: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype._schedule = function(b, c) {
            ...
            d.actions.push(this);
            d.scheduledId || (d.scheduledId = k.Immediate.setImmediate(function() {
              d.scheduledId = null;
              d.flush();
            }));
            return this;
          ...
          b.prototype._unsubscribe = function() {
            ...
            0 === d.length && (b.active = !1, null != c && (b.scheduledId = null, k.Immediate.clearImmediate(c)));
          };
          return b;
